...
@section('content')
    ...
    <div class="container_ch">
        <div class="home_header">Кабинет клиента</div>
        <div class="home_main">
            <div class="home_left">
                <ul class="home_ul">
                    <a href="#"><li style="width: 100px" class="home_li">Профиль</li></a>
                    <a href="#"><li style="width: 240px" class="home_li"></li></a>
                    <a href="{{route('messages')}}"><li style="width: 130px" class="home_li">Сообщения</li></a>
